package com.nuget.themedievalmod.client.screen;
...
public class AnvilScreen extends ContainerScreen<AnvilContainer> {
	...
	private static final ResourceLocation SMITHY_ANVIL_GUI = new ResourceLocation(MedievalMod.MOD_ID,
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int mouseX,
		...
		this.minecraft.textureManager.bindTexture(SMITHY_ANVIL_GUI);
